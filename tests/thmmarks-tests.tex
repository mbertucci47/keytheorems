...
%%
%% multline experimental
%%
% \makeatletter
%   \let\AMSDEFAULTmultline@qed\multline@qed
%   \def\multline@qed{%
% %    \relax
% %    \ifmmode
...
%         \hbox{\hskip\multlinegap\qedsymbol}%
%       \fi
% %    \else
% %       \aftergroup\linebox@qed
% %    \fi
%   }
%   \expandafter\let\csname multline*@qed\endcsname\multline@qed
%   %
%   %% restore
%   % \let\multline@qed\AMSDEFAULTmultline@qed
%   % \expandafter\let\csname multline*@qed\endcsname\AMSDEFAULTmultline@qed
% \makeatother
\makeatletter
\let\AMSDEFAULTmultline@qed\multline@qed
\def\multline@qed{\aftergroup\linebox@qed}
\expandafter\let\csname multline*@qed\endcsname\multline@qed
\makeatother
...
\section{Tests of nested theoremlike environments}
...
Note: The endmark is present in the previous example, but not the next one.
...
\begin{enumerate}
\item ways to disable the thmmark for one box and
