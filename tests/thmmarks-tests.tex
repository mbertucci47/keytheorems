...
\subsubsection*{some other environments}
...
\begin{test} 
  ...
  \begin{equation*}
    ...
    \left|              % vertical bar fence
      ...
      \end{array}
    \right| \noqed 
  \end{equation*}\pushQED{\hfill\qedsymbol}\qedprev[1.5]
\end{test}
