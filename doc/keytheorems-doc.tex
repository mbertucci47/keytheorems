...
For \pkg{memoir} and the AMS classes, \pkg{keytheorems} tries to copy the formatting of these commands as defined by the class.
...
For \pkg{memoir} and the AMS classes, the indent is initially |0pt|.
