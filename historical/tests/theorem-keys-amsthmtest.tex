...
%% Equivalent 'theorem-keys' declarations are given adjacent.
...
\NewThm{thm}[name=Theorem, parent=section]
\NewThm{cor}[name=Corollary, sibling=thm]
\NewThm{prop}[name=Proposition]
\NewThm{lem}[name=Lemma, sibling=thm]
...
\NewThm{rmk}[name=Remark, numbered=false, style=remark]

%\theoremstyle{remark}
%\newtheorem*{rmk}{Remark}

\NewThm{Ahlfors}[name=Ahlfors' Lemma, numbered=false]
...
\NewThm{note}[style=note] % no 'name' key means capitalize first letter
...
\NewThm{varthm}[name={}, numbered=false, style=citing]
...
\NewThm{bthm}[name=B-Theorem, style=break]

%\theoremstyle{break}
%\newtheorem{bthm}{B-Theorem}

\NewThmStyle{exercise}{
  bodyfont=\normalfont,
  headpunct={:}
  }
\NewThm{exer}[name=Exercise, style=exercise]

%\theoremstyle{exercise}
%\newtheorem{exer}{Exercise}

\NewThmStyle{swap}{headstyle=swapnumber}
\NewThm{thmsw}[name=Theorem, parent=section, style=swap]
\NewThm{corsw}[name=Corollary, sibling=thmsw, style=swap]
\NewThm{propsw}[name=Proposition, style=swap]
\NewThm{lemsw}[name=Lemma, sibling=thmsw, style=swap]
